...
public class LogoutFilter extends GenericFilterBean {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        if (requiresLogout(request, response)) {
            ...
            //by lys add --start
            SimpleUrlLogoutSuccessHandler urlLogoutSuccessHandler = new SimpleUrlLogoutSuccessHandler();
			if (request.getServletPath().matches("/index/logout.*")) {
				  urlLogoutSuccessHandler.setDefaultTargetUrl("/index"); 
			}else if(request.getServletPath().matches("/wap/logout.*")){
				urlLogoutSuccessHandler.setDefaultTargetUrl("/wap"); 
			}else{
				urlLogoutSuccessHandler.setDefaultTargetUrl("/system/admin"); 
			}
            logoutSuccessHandler = urlLogoutSuccessHandler;
            //by lys add --end
