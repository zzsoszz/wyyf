...
public final class DateConverUtil {
	...
	public enum TimeType {
		...
		//,/**"MM/dd/yy HH:mm:ss"*/type3("MM/dd/yy HH:mm:ss")
		//,/**"MM/dd/yy HH:mm"*/type31("MM/dd/yy HH:mm")
		//,/**"MM/dd/yy"*/type311("MM/dd/yy")
		
		,/**"yyyy.MM.dd HH:mm:ss"*/type4("yyyy.MM.dd HH:mm:ss")
		,/**"yyyy.MM.dd HH:mm"*/type41("yyyy.MM.dd HH:mm")
		,/**"yyyy.MM.dd"*/type411("yyyy.MM.dd")
		,/**"yyyy.MM.dd"*/type4111("yyyy.MM")
		
		,/**"yyMMdd HH:mm:ss"*/type5("yyyyMMdd HH:mm:ss")
		,/**"yyMMdd HH:mm"*/type51("yyyyMMdd HH:mm")
		,/**"yyMMdd"*/type511("yyyyMMdd")
		,/**"yyMMdd"*/type5111("yyyyMM")
		
		,/**"yyyy年MM月dd日 HH:mm:ss"*/type6("yyyy年MM月dd日 HH:mm:ss")
		,/**"yyyy年MM月dd日 HH:mm"*/type61("yyyy年MM月dd日 HH:mm")
		,/**"yyyy年MM月dd日"*/type611("yyyy年MM月dd日")
		,/**"yyyy年MM月dd日"*/type6111("yyyy年MM月")
		
		,/**"HH:mm:ss"*/type7("HH:mm:ss");
