...
public class StringUtils extends org.springframework.util.StringUtils {
	...
	/**
	 * 处理不同数据库中的sql语句--时间转字符串
	 * @param obj
	 * @return
	 */
	public static String trunTypeByString(String s){
		if(SysStatic.MYSQL.equals(SysStatic.dbName)){
			s= "date_format("+s+",'%Y-%m-%d %T')";
		}else if(SysStatic.ORACLE.equals(SysStatic.dbName)){
			s= "to_char("+s+",'yyyy-mm-dd hh24:mi:ss')";
		}
		return s;
	}
	...
	public static String getI18nLanguage(String accept_language,String msgname){
		if(org.springframework.util.StringUtils.hasText(accept_language)){
