 ...
 * Generated at: 2015-09-13 17:29:02 UTC
...
public final class activityAdd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("活动</span><span class=\"zhus\">注：带【<span style=\"color: red;\">*</span>】为必填项！</span></h4>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t<div class=\"caption\"><i class=\"fa fa-reorder\"></i>活动基本信息</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<label class=\"control-label col-md-4\">活动编号</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div style=\"display:none;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"bo_st_id\" type=\"text\" value=\"\" alt=\"活动ID\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input name=\"bo_st_ddnum\" type=\"text\" class=\"form-control\"   readonly=\"readonly\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t<div class=\"col-md-6\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"control-label col-md-4\">活动标题<span style=\"color: red;\">*</span></label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input name=\"bo_st_title\" type=\"text\" class=\"form-control\" datatype=\"*2-50\"   errormsg=\"姓名至少2个字符，最大50个字符\" />\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"col-md-6\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"control-label col-md-4\">是否发布<span style=\"color: red;\">*</span></label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t<div class=\"col-md-6\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"control-label col-md-4\">时间开始</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-8\">                                                                     \r\n");
      out.write("\t\t\t\t\t\t\t\t<input name=\"bo_dt_startDate\" type=\"text\" class=\"form-control form-control-inline input-group form_advance_datetime\"  size=\"16\"  datatype=\"*\"   nullmsg=\"请输入开始时间！\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"col-md-6\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"control-label col-md-4\">时间结束</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-8\">                                                                     \r\n");
      out.write("\t\t\t\t\t\t\t\t<input name=\"bo_dt_endDate\" type=\"text\" class=\"form-control form-control-inline input-group form_advance_datetime\"  size=\"16\" datatype=\"*\"   nullmsg=\"请输入结束时间！\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div> \r\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"control-label col-md-2\">活动主题</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<textarea name=\"bo_st_ddremark\"  rows=\"3\" class=\"form-control\" maxlength=\"250\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t<input  type=\"text\" class=\"form-control\" value=\"保存时候系统自动计算\" readonly=\"readonly\"  style=\"width: 550px; display: inline;\" />\r\n");
      ...
      out.print(wymark );
      out.write(".bp_st_remark\" class=\"form-control autocomplete\"  style=\"width: 550px; display: inline;\" value=\"\" datatype=\"*\"  nullmsg=\"请输入商品名称！\" />\r\n");
      out.write("\t\t\t\t\t\t\t<div style=\"display:none;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input  type=\"text\" name=\"");
      out.print(wymark );
      out.write(".bp_st_spnum\" datatype=\"*\"  nullmsg=\"请输入商品号！\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t<input  type=\"text\" name=\"");
      out.print(wymark );
      out.write(".bp_st_bbid\"  />\r\n");
      out.write("\t\t\t\t\t\t\t\t<input  type=\"text\" name=\"");
      out.print(wymark );
      out.write(".bp_st_id\" markName=\"ID\" markCode=\"bp_st_id\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t本次活动单价<span style=\"color: red;\">*</span><input name=\"");
      out.print(wymark );
      out.write(".bp_st_spprice\" type=\"text\" style=\"width: 100px; display: inline;\"  class=\"form-control\" value=\"\"  datatype=\"/^(([1-9]\\d*)|0)(\\.\\d{1,2})?$/\"  errormsg=\"请输入大于0的数字，且最多2位小数！\" >\r\n");
      out.write("\t\t\t\t\t\t\t商品数量<span style=\"color: red;\">*</span>\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"");
      out.print(wymark );
      out.write(".bp_st_spsl\" type=\"text\" style=\"width: 100px; display: inline;\" class=\"form-control\" value=\"\" datatype=\"/^(0|([1-9]\\d*))$/\" errormsg=\"请输入10位以内的数字！\" nullmsg=\"请输入商品数量！\" maxlength=\"10\" >\r\n");
      ...
      out.write("\t\t<button type=\"button\" id=\"saveBtn\"  class=\"btn blue\">确认创建</button>\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t\t\t\tbootbox.confirm('确定是否新增活动？',function(rs){\r\n");
      out.write("\t\t\t\t\tif(rs){\r\n");
      out.write("\t\t\t\t\t\tnewMask();\r\n");
      ...
      out.write("\t\t\t\t\t    \t\t\tif(rs){\r\n");
      out.write("\t\t\t\t\t    \t\t\t\tloadMainPage('wyyf/activity/intoOrderSave');//刷新本界面\r\n");
      out.write("\t\t\t\t\t    \t\t\t}\r\n");
      out.write("\t\t\t\t\t    \t\t});\r\n");
      out.write("\t\t\t\t\t\t\t}else{ \r\n");
      ...
      out.write("\t\t      formv.find(\"input[name$='.bp_st_spnum']\").val(data.bg_st_num);\r\n");
      out.write("\t\t      formv.find(\"input[name$='.bp_st_bbid']\").val(data.bg_st_bbid);\r\n");
      out.write("\t\t      formv.find(\"input[name$='.bp_st_spprice']\").val(data.price);\r\n");
      out.write("\t       });\r\n");
      out.write("    \t//新增失去焦点事件\r\n");
      out.write("\t\t$(\".autocomplete\").blur(function(){\r\n");
      out.write("\t\t\t $(this).val(obtain($(this).parents(\"div.addBorder\").first().find(\"input[name$='.bp_st_spnum']\").val()));\r\n");
      out.write("\t\t});\r\n");
      out.write("    }\r\n");
  ...
  private boolean _jspx_meth_my_005fselect_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/wyyf/activity/activityAdd.jsp(56,8) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_my_005fselect_005f0.setName("bo_st_ddstate");
    // /WEB-INF/jsp/wyyf/activity/activityAdd.jsp(56,8) name = clazz type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_my_005fselect_005f0.setClazz("form-control");
    // /WEB-INF/jsp/wyyf/activity/activityAdd.jsp(56,8) name = nameKey type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
