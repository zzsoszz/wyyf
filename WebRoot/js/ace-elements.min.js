...
jQuery(function() {
        ...
        for (var p = 0; p < n.length; p++) {
            ...
            if (!this.well_style) {
                this.$label.find(".file-name").attr({
                    "data-title": l
                }).find('[class*="fa-"]').attr("class", m)
            } else {
                this.$label.append('<span class="file-name" data-title="' + l + '"><i class="' + m + '"></i></span>');
                var r = e.trim(n[p].type);
                var o = b && this.settings.thumbnail && ((r.length > 0 && r.match("image")) || (r.length == 0 && m == "fa fa-picture-o"));
                if (o) {
                    var s = this;
    ...
    f.prototype.reset_input = function() {
        this.$label.attr({
            ...
            "class": "file-name"
        }).find('[class*="fa-"]').attr("class", this.settings.no_icon).prev("img").remove();
        if (!this.settings.no_icon) {
            this.$label.find('[class*="fa-"]').remove()
        }
    ...
    a.fn.ace_wysiwyg = function(c, h) {
        ...
        var g = {
            font: {
                values: ["宋体", "信使", "MS漫画SANS", "黑体", "微软细明体", "大河马字体", "Verdana"],
                icon: "icon-font",
                title: "字体"
            },
            fontSize: {
            ...
            bold: {
                icon: "icon-bold",
                title: "粗体 (按Ctrl/Cmd+B)"
            },
            italic: {
                icon: "icon-italic",
                title: "斜体 (按Ctrl/Cmd+I)"
            },
            strikethrough: {
            ...
            justifyleft: {
                ...
                title: "左对齐 (按Ctrl/Cmd+L)"
            },
            justifycenter: {
                icon: "icon-align-center",
                title: "居中 (按Ctrl/Cmd+E)"
            },
            justifyright: {
                icon: "icon-align-right",
                title: "右对齐 (按Ctrl/Cmd+R)"
            },
            justifyfull: {
            ...
            undo: {
                icon: "icon-undo",
                title: "撤消 (按Ctrl/Cmd+Z)"
            },
            redo: {
                icon: "icon-repeat",
                title: "重做 (按Ctrl/Cmd+Y)"
            },
            viewSource: {
                icon: "icon-code",
                title: "View Source"
