...
<div class="portlet box blue">
	...
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-globe"></i>视频列表</div>
		<div class="actions">
	...
	<div class="portlet-body">
		<div title="查询条件">
			<form id="queryForm">
				内容：<input type="text" name="bj_st_title" class="form-control" style="width: 200px;display: inline;">
				类型：<my:select name="bj_st_type" clazz="form-control" nameKey="ADVERTADTYPE" isAddDefaltOption="true" defaltOptionKey="" defaltOptionValue="-请选择-"  style="width: 200px;display: inline;"/>
	...
	<div class="modal-dialog modal-wide">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title"><span id="addOrEditor">新增门户设置</span><span class="zhus">注：带【<span style="color: red;">*</span>】为必填项！</span></h4>
			</div>
						...
						<div class="col-md-6">
							<%-- <div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-md-8">
										<my:select name="bj_st_type" clazz="form-control" nameKey="ADVERTADTYPE" />
									</div>
								</div>
							</div> --%>
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label col-md-4">视频名称</label>
									<div class="col-md-8">
										<div style="display: none;">
											<input name="br_st_id" type="text" value="">
											<!-- <input name="br_st_userid" type="text" value="">
											<input name="br_st_addDate" type="text" value=""> -->
										</div>
										<input name="br_st_name" type="text" class="form-control" placeholder="" maxlength="100" >
									</div>
								</div>
							</div>
						<!-- 	<div class="col-md-12">
								<div class="form-group">
									<label class="control-label col-md-4">相关商品号</label>
									<div class="col-md-8">
										<input name="bj_st_clickurl" type="text" class="form-control" placeholder=""  maxlength="100">
									</div>
								</div>
							</div> -->
						<!-- 	<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-md-8">
										<input name="bj_nm_orderno" type="text" class="form-control" value="0" placeholder="" datatype="/^\d{1,4}$/"  nullmsg="请输入门户设置序号！" errormsg="门户设置序号只能为1-4位非负整数！">
									</div>
								</div>
							</div> -->
						<%-- 	<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-md-8">
										<my:select name="bj_st_enable" clazz="form-control" nameKey="YESNO"  />
									</div>
								</div>
							</div> --%>
						</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-md-10">
									<textarea name="br_st_url" class="form-control" rows="3" maxlength="5000"></textarea>
								</div>
							</div>
						</div>
					</div>
...
<script>
	...
	$(function(){
		...
		$("#saveBtn").click(function(){
			checkFormValid($("#addForm"),function(){
				newMask();
				var id=$("#addForm input[name='br_st_id']").val();
				$("#addForm").form('submit',{
					url:"wyyf/video/sysVideoAdd",  
	...
	function editAdvertisement(obj){
		$("#addForm")[0].reset();
		var brid=$(obj).parents("tr").first().find("input[type='checkbox'].checkboxes").val();
		alert(brid);
		var url = "wyyf/video/findVideoById";
		newMask();
		$.post(url,"brid="+brid,function callback(data){   
			delMask();
			var resp = eval("("+data+")"); 
			if(resp.success){
	...
	/* function delAdvertisement(obj){
		bootbox.confirm('确定是否删除？',function(rs){
			if(rs){
				...
				var url = "wyyf/video/advertisementDelete";
				$.post(url,"advertisementId="+advertisementId,function callback(data){  
					delMask();
					var resp = eval("("+data+")"); 
					if(resp.success){
						RefreshCurPage();//刷新当前页，--该函数在 commonList.jsp中
