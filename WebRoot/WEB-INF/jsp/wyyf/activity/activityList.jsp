...
<div class="portlet box blue">
	...
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-globe"></i>活动列表</div>
		<div class="actions">
	...
	<div class="portlet-body">
		<div title="查询条件">
			<form id="queryForm">
				活动编号：<input type="text" name="bo_st_ddnum" class="form-control" style="width: 200px;display: inline;" >
				是否发布：<my:select name="bo_st_ddstate" clazz="form-control" nameKey="YESNO" isAddDefaltOption="true" defaltOptionKey="" defaltOptionValue="-请选择-" style="width: 200px;display: inline;"/>
	...
	<div class="modal-dialog modal-wide">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4  class="modal-title"><span id="titleText">编辑活动信息</span><span class="zhus">注：带【<span style="color: red;">*</span>】为必填项！</span></h4>
			</div>
...
<script>
	...
	function loadotherPage(params) {
		...
		var url="wyyf/activity/activityList";
	...
	function editBtn(obj){
		...
		newMask();
		jQuery("#addFormbodyDIV").load("wyyf/activity/queryInfo","id="+orderFormId,function(response,status,xhr){
			delMask();
			if(xhr.status==403){
				$(this).html(xhr.responseText);
			}else if(xhr.status==404){
	...
	//删除活动信息
	function delBtn(obj){
		bootbox.confirm('确定是否删除该活动？',function(rs){
			if(rs){
				newMask();
				var orderFormId=$(obj).parents("tr").first().find("input[type='checkbox'].checkboxes").val();
				var url = "wyyf/activity/activitydelete";
