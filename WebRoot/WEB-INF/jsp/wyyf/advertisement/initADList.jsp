...
<div class="portlet box blue">
	...
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-globe"></i>广告列表</div>
		<div class="actions">
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<div style="display: none;">
											<input name="bj_st_id" type="text" value="">
											<input name="ag_st_id" type="text" value="" alt="文件ID">
											<input name="ag_st_url" type="text" value="" alt="文件路径">
										</div>
										<input name="bj_st_title" type="text" class="form-control" placeholder="" maxlength="100" >
									</div>
								</div>
							</div>
							<div class="col-md-12">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-md-10">
									<textarea name="bj_st_remark" class="form-control" rows="3" maxlength="250"></textarea>
								</div>
							</div>
						</div>
					</div>
...
<script>
	...
	$(function(){
		...
		$("#saveBtn").click(function(){
			checkFormValid($("#addForm"),function(){
				...
				$("#addForm").form('submit',{
					url:"wyyf/advertisement/sysAdvertisementAdd",  
	...
	function loadotherPage(params) {
		...
		var url="wyyf/advertisement/advertisementList";
	...
	function editAdvertisement(obj){
		...
		var url = "wyyf/advertisement/findAdvertisementById";
		newMask();
	...
	function delAdvertisement(obj){
		bootbox.confirm('确定是否删除？',function(rs){
			if(rs){
				newMask();
				var advertisementId=$(obj).parents("tr").first().find("input[type='checkbox'].checkboxes").val();
				var url = "wyyf/advertisement/advertisementDelete";
				$.post(url,"advertisementId="+advertisementId,function callback(data){  
					delMask();
					var resp = eval("("+data+")"); 
					if(resp.success){
