...
<div class="dsigback" style="">
	 <div class="dsignbox" style="">
	 	<div class="blank" style=""></div>
	 	        <ul class="breadcrumb" style="text-align: left;">
                   ...
                   <li><a href="">我要装修</a></li>
                   <li><a href="">找师傅</a></li>
                   <li class="active"><a href="index/masterDetail">师傅详情</a></li>
                   <li><a>预约师傅</a></li>  
              </ul>
	 	  ...
	 	  <form id="addform" name="formbm" method="post" action="#">
             ...
             <!--     <div class="baoming_input baoming_input1">
                 ...
                 <div class="baoming_in">
                     <span class="baoming_span1">楼盘/地址</span>:<input type="text" name="bf_st_address"  id="bf_st_address">
                 </div>
                 <div class="baoming_in">
                     <span class="baoming_span1">房屋面积</span>:<input style="outline: medium none;" type="text" name="bf_st_area"  id="bf_st_area">
                 </div>
                 <div class="baoming_in">
                     <span class="baoming_span1">预约金</span>:<input style="outline: medium none;" type="text" readonly="readonly" value="100" name="yy_maney"  id="yy_maney">
                 </div>
                 <div class="baoming_in">
			     ...
			     <div class="baoming_bu">		
					 <input type="hidden" name="type" value="8"  id="type"/>     <!-- 预约类型    -->
 ...
 <div style="display: none;" class="check_out" id="checkok">
  	    ...
  	    <div class="check_outpoint">
  	    	您好，您已成功预约师傅，请等待审核。工作人员会在24小时内与您取得联系，请注意接听电话。<br/>
		...
		<script type="text/javascript">
			...
			function toPay(){
				...
				/* var bj_maney=$().val("bj_bj_maney"); */
				/* var money=parseFloat(area); */
				location.href="index/toPay?yy_maney="+yy_maney+"&address="+address+"&area="+area+"&type="+type+"&rid="+rid;
			}
		</script>
</div>
