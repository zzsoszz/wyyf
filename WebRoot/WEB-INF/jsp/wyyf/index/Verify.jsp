	 ...
	 <div class="dsignbox" style="">
         ...
         <!--  <div class="dsignboxtop" style="">
          ...
          <div class="dsignboxin clearfix" style="">
          	 ...
          	 <div style="margin-left: -80px;">共${LabourTotal}位验房师</div>
          </div>
       ...
       <c:forEach items="${su_supervisionlist.getList()}" var="val" varStatus="i">
    	   ...
    	   <a href="index/checkManDetail?id=${val.ba_st_userid}&sid=${sid}">
    	       ...
    	       <div class="tuijie_pepole_check">
	    	       <a href="index/checkManDetail?id=${val.ba_st_userid}&sid=${sid}">预约</a>
    	       </div>
    	  </div>
       </c:forEach>
    	 </div>
...
<script type="text/javascript" src="js/eshop/yfs.js?v1.1"></script>
