...
<div class="dsigback">
	 <div class="dsignbox" style="">
         <div class="cheap_road" style="">
	 	  	  <ul class="breadcrumb" style="">
                   ...
                   <li class="active"><a>我要验房</a></li>
              </ul>
	 	  </div>
        <div class="designshow_boxtop clearfix" style="">
        	<c:forEach items="${ov_checkManDetaillist1}" var="val" varStatus="i">
        	...
        	<div class="designshow_boxtop_right" style="">
        	   <p class="clearfix">
        	        <span class="tuijie_pepole_name f_fl">${val.ae_st_name}</span>  	
        	    ...
        	    <%-- <div class="desin_show_check"><a href="javascript:checkLoginUser('${val.ae_st_id}','${sid}')">预约他验房</a></div> --%>
        	</div>
        </div>
     ...
     <div class="designshow_boxbottom clearfix" style="">
     		...
     		<div class="fixgz_blt" style="">评价详情</div>
     		  <div id="temp5">
			     <div class="JQ-content-box">
					...
					<li>
						<div style="">
						<c:forEach items="${ov_checkManDetaillist2}" var="val" varStatus="i">
     	...
     	<div class="fixgz_bott_right" style="">
     	    ...
     	    <c:forEach items="${ov_checkManDetaillist3}" var="val" varStatus="i">
...
function checkLoginUser(rid,sid){
	...
	if(userid==null||userid==''){
		...
		location.href="index/checkManOrder?rid="+rid+"&sid="+sid;
	}
}
</script>
