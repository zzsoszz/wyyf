	...
	<input type="hidden" id="Up" value="${Up}" />
	 <div class="dsignbox" style="">
       ...
       <c:forEach items="${su_supervisionlist.getList()}" var="val" varStatus="i">
    	   ...
    	   <a href="index/overmanDetail?id=${val.ba_st_userid}&sid=${sid}">
    	       ...
    	       <span class="dessty_instar clearfix"><span class="glyphicon glyphicon-star"></span></span>
			   </c:forEach>
    	       <div class="dessty_ingood"><strong class="redcolor">RMB：${val.ba_st_price}元/平米</strong><span class="airnum" >接单数：${val.COUNT==null?0:val.COUNT}</span></div>
    	      </a>
    	       <div class="tuijie_pepole_check">
	    	       <a href="index/overmanDetail?id=${val.ba_st_userid}&sid=${sid}">预约</a>
    	       </div>
    	  </div>
       </c:forEach>
    	 </div>
...
<script type="text/javascript" src="js/eshop/wygz.js?v1.1"></script>
