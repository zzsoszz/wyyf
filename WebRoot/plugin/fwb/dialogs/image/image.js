...
(function () {
    ...
    OnlineImage.prototype = {
        ...
        pushData: function (list) {
            var i, item, img, icon,_del, _this = this,
            ...
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].url) {
                    ...
                    _del = document.createElement('span');
                    ...
                    domUtils.addClass(_del, 'mydel');
                    _del.setAttribute('onclick', "javascript:delImage(this);");

                    item.appendChild(img);
                    item.appendChild(icon);
                    item.appendChild(_del);
